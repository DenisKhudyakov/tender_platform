...
class SignUpForm(UserCreationForm):
    ...
    email = forms.EmailField(max_length=255, help_text='Введите электронную почту. Обязательное поле.',
                             widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Логин'}))
...
class LoginForm(AuthenticationForm):
    ...
    username = forms.CharField(widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Логин'}),
                               label='Адрес электронной почты', help_text='Введите электронную почту')
